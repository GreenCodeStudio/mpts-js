...
export class AbstractParser {
  ...
  throw(message) {
    throw new MptsParserError(message, this.currentCodePosition, this.text.substr(this.position, 10));
  }
  ...
  get currentCodePosition() {
    return new CodePosition(this.fileName, this.currentLineOffset, this.currentColumnOffset, this.currentFilePosition);
  }
}